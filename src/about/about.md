...
const members = [
    {
        avatar: 'https://pics-a1c.pages.dev/ng_web/about/about/kKsk.jpg',
        name: 'kKsk03',
        title: '服务器创始人 & 开发者',
        links: [
            { 
    ...
    {
        avatar: 'https://pics-a1c.pages.dev/ng_web/about/about/Raven.jpg',
        name: 'RavenEye',
        title: '服务器合伙人 & 管理员',
        links: [
            { 
    ...
    {
        avatar: 'https://pics-a1c.pages.dev/ng_web/about/about/Jason.jpg',
        name: 'Jason',
        title: '服务器管理员 & 湾岸大肌霸',
        links: [
            { 
    ...
    {
        avatar: 'https://pics-a1c.pages.dev/ng_web/about/about/Ryo.jpg',
        name: 'RL-01',
        title: '服务器管理员',
        links: [
            { 
            ...
            { icon: 'github', link: 'https://github.com/Liner-Ryo' }
        ]
    },
]
</script>
