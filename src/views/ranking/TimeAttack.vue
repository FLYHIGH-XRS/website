<template>
    ...
    <!-- 电脑端布局 -->
    <table class="table table-striped table-hover pc_table" style="width: 100%; table-layout: fixed;">
        <thead>
    ...
    <!-- 手机端布局 -->
    <table class="table table-striped table-hover mobile_table" style="width: 100%; table-layout: fixed;">
        <tbody>
